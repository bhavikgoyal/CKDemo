...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.applyClass = 'btn-success b_s';
            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn"  disabled="disabled" type="button"><i class="fa fa-check"></i></button> ' +
                        '<button class="cancelBtn" type="button"><i class="fa fa-times"></i></button>' +
                    '</div>' +
                '</div>' +
            '</div>';
